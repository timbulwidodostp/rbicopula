...
{viewerjumpto "Examples" "rbicopula postestimation##examples"}{...}
{hline}
{hi:help rbicopula postestimation}{right:{browse "https://github.com/cobanomics/rbicopula":github.com/cobanomics/rbicopula}}
{hline}
{right:also see:  {help rbicopula: help rbicopula}}

{marker description}{...}
{title:Postestimation commands}

{pstd}
The following postestimation commands are of special interest after {cmd:rbicopula}:

{synoptset 19}{...}
{p2coldent :Command}Description{p_end}
{synoptline}
{synopt :{helpb rbicopula_margdec:rbicopula margdec}}
	marginal means, predictive margins, marginal effects, and average marginal effects 
	of {it:indepvars} and {it:indepvars}_en
	{p_end}
{synopt :{helpb rbicopula_tmeffects:rbicopula tmeffects}}
	treatment effects of treatment variable {it:depvar}_en
	{p_end}
{synoptline}
{p2colreset}{...}

{pstd}
The following postestimation commands are available after {cmd:rbicopula}:
...
{synopt :{helpb rbicopula postestimation##predict:predict}}predictions, residuals, influence statistics, and other diagnostic measures{p_end}
...
{phang}
{opt xb1} calculates the linear prediction for the outcome equation.

{phang}
{opt xb2} calculates the linear prediction for the treatment equation.
...
{phang}
	...
	outcome equation and/or treatment equation for {cmd:rbicopula}. It modifies the 
...
{pmore}
	...
	respect to the third equation ({hi:delta}).
